                ...
                {featured.map((goal) => {
                  ...
                  return (
                    <Link
                      ...
                      className="group flex flex-col items-start gap-2.5 rounded-lg border border-border bg-surface p-3.5 transition-colors hover:border-accent-border hover:bg-surface-2 sm:p-4"
                    >
